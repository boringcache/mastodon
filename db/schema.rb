...
ActiveRecord::Schema[8.1].define(version: 2026_08_11_125012) do
  ...
  create_table "moderation_suggestions", force: :cascade do |t|
    ...
    t.index ["target_type", "target_key"], name: "index_moderation_suggestions_on_target_type_and_target_key", unique: true
  end
